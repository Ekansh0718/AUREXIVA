...
export const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col bg-background">
      {/* 2. Hero Section (Height: calc(100vh - 68px)) */}
      <section className="relative w-full bg-white border-b border-border-custom overflow-hidden lg:h-[calc(100vh-68px)] flex items-center py-8 lg:py-0">
